...
void send_init_message(BuildTree &tree, int name_count)
{
	...
	int seq_no = getRunSequenceNo(
			this_peer->getConfiguration()->getSeqFilePath());
	string log_server_user =
			this_peer->getConfiguration()->getLogServerUserName();
...
int main(int argc, char* argv[])
{
	...
	this_peer->setListenPortNumber(
			this_peer->getConfiguration()->getClientListenPort());
