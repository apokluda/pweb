...
namespace client
{
    ...
    struct mini_xml_grammar
      : qi::grammar<Iterator, mini_xml(), qi::locals<int>, ascii::space_type>
    {
        mini_xml_grammar()
        ...
        qi::rule<Iterator, mini_xml(), qi::locals<int>, ascii::space_type> xml;
        qi::rule<Iterator, mini_xml_node(), ascii::space_type> node;
        qi::rule<Iterator, std::string(), ascii::space_type> text;
        qi::rule<Iterator, std::string(), ascii::space_type> start_tag;
        qi::rule<Iterator, void(int), ascii::space_type> end_tag;
    };
    //]
}
